%% novelty_comparison_multi_days.m
%  this code creates line plots and boxplots for Figures 1, 3, 4, and S2

%  input: bout_multi.mat (created in analy_novelty2103.m)
...
Bout_zscore_bigcontrol = Bout_min_bigcontrol;
...
%% Fig 3e; 3c/d and 4d/e frequency comparison
plotWin = 1:25*6;
plotColors = {'k','r'};
