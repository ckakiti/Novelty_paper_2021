...
subplot(length(initial),5,5*(initial_n-1)+1)
winterColors = colormap(winter(9));
plot(T(2:end),[delta(1,1:(end-1)) 0],'Color',winterColors(1,:))
hold on
plot(T(2:end),[delta(21,1:(end-1)) 0],'Color',winterColors(2,:))
...
subplot(length(initial),5,5*(initial_n-1)+2)
winterColors = colormap(winter(9));
plot(T,[V(1,1:(end-1)) 0],'Color',winterColors(1,:))
hold on
plot(T,[V(21,1:(end-1)) 0],'Color',winterColors(2,:))
...
subplot(length(initial),5,5*(initial_n-1)+3)
plot(delta(:,t_stim2),'-')
axis([0 500 -0.5 2])
xlabel('trial')
...
s_plot = sqrt(2*pp); % 95.4%
plotWin = 1:501;
subplot(length(initial),5,5*(initial_n-1)+4)
errorbar_patch(plotWin,m_plot',s_plot,'b');
xlabel('trial')
ylabel('TP at object')
box off
...
s_plot = sqrt(2*pp); % 95.4%
plotWin = 1:501;
subplot(length(initial),5,5*(initial_n-1)+5)
errorbar_patch(plotWin,m_plot',s_plot,'b');
xlabel('trial')
ylabel('TP at 4')
box off
