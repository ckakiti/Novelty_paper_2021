...
figure
subplot(1,2,1)
histogram(mean_tail_behind_10min - mean_tail_behind_d24,-10:2:10)
xlabel('/min (10min minus day2-4)')
ylabel('animal number')
title('bout frequency with tail behind')
box off
set(gca,'tickdir','out')
set(gca,'TickLength',2*(get(gca,'TickLength')))
set(gca,'FontSize',20)
...
subplot(1,2,2)
histogram(mean_with_tail - mean_tail_before,-10:2:10)
xlabel('/min (d2-4 minus baseline)')
ylabel('animal number')
title('bout frequency with tail exposure')
box off
set(gca,'tickdir','out')
set(gca,'TickLength',2*(get(gca,'TickLength')))
set(gca,'FontSize',20)
